...
urlpatterns = [
    ...
    path('category_stationaries_page/',
         include('category_stationaries_page.urls')),
    path('category_sports_page/', include('category_sports_page.urls')),
    path('category_musical_instruments_page/',
         include('category_musical_instruments_page.urls')),
